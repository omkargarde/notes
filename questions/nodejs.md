...
You gotta know a bit of everything, even tho nodejs is backend, they can plot
twist you with a frontend type questions but at a high level:
...
- what are the best practices for handling sensitive data?
  (e.g., env variables, secrets management)

## Code challenges / hands-on exercises

- implement a custom promise class from scratch.

- write a function that limits the number of
  concurrent asynchronous tasks running at a time.
