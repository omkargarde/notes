...
- Can you explain the architecture of your last project?
- What production issues did you handle on that project?
- Have you led any cross‑functional teams? (i have not)
...
- A button works in development but not in production—what steps would you take?
...
- What are the differences between the event loop, micro-task queue,
...
- An application running for two days shows continuously
  increasing memory—what could be the issue?
- What happens if an unhandled rejection occurs in Node 16?
- How does SQL indexing improve performance?
- How would you design a high‑traffic e‑commerce order system handling
  100k orders with payment integration?
- nodejs SFCC/SFRE what is it?

## Resume-Based / Experience Questions (STAR Answers)

### Tell me about the project you worked on at Terralogic

**Situation:** Worked on an internal dashboard project for Fujitsu’s network
team.  
**Task:** Build a UI to monitor router health, network links,
and possible geo-locations of failures.  
**Action:** Integrated APIs, fixed functional bugs,
and improved UI stability and styling.  
**Result:** Delivered a reliable monitoring dashboard used by internal
teams for faster issue detection.
...
**Action:** Integrated REST APIs, resolved functional bugs,
and fixed CSS issues affecting usability.  
...
**Action:** Broke components into smaller units, used props effectively,
avoided unnecessary Redux usage, and shared common components.  
...
**Action:** Used RTK Query since it was already adopted; centralized
API definitions using `createApi`, leveraged caching and auto-refetching.  
...
**Action:** Tested layouts at multiple breakpoints, used media queries,
followed W3C guidelines, checked ARIA labels and contrast in DevTools,
...
**Action:** Used route-based structure, feature folders, shared components,
Redux store folder, utilities, and custom hooks.  
...
**Action:** Used RTK Query / TanStack Query to manage caching, loading,
